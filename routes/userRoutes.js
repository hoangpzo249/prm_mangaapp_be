...
const { adminCreateUserRules, adminUpdateUserRules } = require('../middlewares/validators/userValidator');
...
router.put('/:id/reset-password', auth, authorize('admin'), userController.adminResetPassword);
